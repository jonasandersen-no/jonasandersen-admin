...
record CreateInstanceRequest(String region, String image, String label, String type, List<String> tags,
                                    @JsonProperty("root_pass") String rootPassword, Boolean volume) {

  static CreateInstanceRequest from(InstanceDetails details) {
