...
public record ServerGeneratorResponse(
    Long linodeId, String label, Ip ip, java.util.List<String> tags) {

  public static ServerGeneratorResponse from(LinodeInstance instance) {
    return new ServerGeneratorResponse(
        instance.linodeId().id(),
        instance.label(),
