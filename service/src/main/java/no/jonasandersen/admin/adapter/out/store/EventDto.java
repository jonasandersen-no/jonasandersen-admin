...
public class EventDto<EVENT extends Event> {
  ...
  /*
      ...
      AggRootID | Version   | EventType         |  JSON Content
      -----------------------------------------------------------------
  ...
  */
  ...
  public EventDto(UUID aggRootId, long version, String eventClassName, String json) {
  ...
  public static <EVENT extends Event> EventDto<EVENT> from(
      UUID aggRootId, long version, EVENT event) {
    ...
    try {
      ...
      return new EventDto<>(aggRootId, version, fullyQualifiedClassName, json);
